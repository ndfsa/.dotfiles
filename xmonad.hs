...
--
main = do
	xmproc_xmobar <- spawnPipe "xmobar ~/.config/xmobar/.xmobarrc"
	xmonad $ docks $ defaults xmproc_xmobar
...
defaults xmproc_xmobar = def {
      ...
      -- hooks, layouts
        ...
        logHook            = myLogHook xmproc_xmobar,
